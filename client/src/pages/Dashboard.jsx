          ...
          {allResumes.map((resume, index) => {
            ...
            return (
              <button
                ...
                className='relative w-full sm:max-w-36 h-48 glex flex-col items-center justify-center rounded-lg gap-2 border group hover:shadow-lg transition-all duration-300 cursor-pointer'
                style={{
              ...
              >
                ...
                />
                <p
                  className='tex-sm group-hover:scale-105 transition-all px-2 text-center'
                  style={{ color: baseColor }}
                >
                  {resume.title}
                </p>
